 ...
 * @author peter
 */
public class WxmlAttributeInsertHandler implements InsertHandler<LookupElement> {
	private static final Logger LOG = Logger.getInstance("#com.intellij.codeInsight.completion.XmlAttributeInsertHandler");

	public static final WxmlAttributeInsertHandler INSTANCE = new WxmlAttributeInsertHandler();

	private final String myNamespaceToInsert;

	public WxmlAttributeInsertHandler() {
		this(null);
	}

	public WxmlAttributeInsertHandler(@Nullable String namespaceToInsert) {
	...
	public void handleInsert(final InsertionContext context, final LookupElement item) {
		...
		// modify + 2
		editor.getCaretModel().moveToOffset(caretOffset + (insertQuotes || hasQuotes ? 2 : 1) + 2);
